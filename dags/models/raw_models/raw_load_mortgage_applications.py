...
def tuncate_table(cursor):
        tuncate_table = """
    truncate table mortgage_applications
        ;
        """
...
def insert_table(cursor):
        ...
        cursor=conn.cursor()
        csv_files = { '/home/kali/Desktop/projects/git/bank_data_processing/dags/data_prepare/mortgage_applications_today.csv': 'mortgage_applications' }
