...
def myfun():
    ...
    df_customers=generate_data(
        ...
        f'{path}customers_historical.csv',
        start_date,
        end_date
    )
    ...
    df_accounts=generate_data(
        ...
        f'{path}accounts_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}transactions_historical.csv',
        start_date,
        end_date
    )
    ...
    df_branches=generate_data(
        ...
        f'{path}branches_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}employees_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}investments_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}customer_support_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}fixed_deposits_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}recurring_deposits_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}online_banking_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}bill_payments_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}insurance_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}credit_scores_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}service_charges_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}savings_goals_historical.csv',
        start_date,
        end_date
    )
    ...
    generate_data(
        ...
        f'{path}mortgage_applications_historical.csv',
        start_date,
        end_date
    )
